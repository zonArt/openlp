...
class Ui_EditVerseDialog(object):
    def setupUi(self, edit_verse_dialog):
        ...
        self.verse_language_combo_box = QtWidgets.QComboBox(edit_verse_dialog)
        self.verse_language_combo_box.addItems(['original', 'translation'])
        self.verse_language_combo_box.setObjectName('verse_language_combo_box')
        self.verse_type_layout.addWidget(self.verse_language_combo_box)
